...
Portal.cart.DownloadPanelItemTemplate = Ext.extend(Ext.XTemplate, {
    ...
    _getHtmlContent: function() {
        return [
            ...
            '      <div class="x-tool-awesome" title="{[this.getTooltip(\"shareButtonTooltip\")]}" id="{[this._getLinkId(values,\'shareButtonId\')]}">{[this._shareButton(values)]}</div>',
    ...
    _shareButton: function(collection) {
    ...
    _createShareButton: function(collection) {
        ...
        if ( Ext.get(elementId)) {
            ...
            this.shareLink = new Ext.ux.Hyperlink({
